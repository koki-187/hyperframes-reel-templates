...
export async function renderVideo({format='reels',seconds=10,headline='14の美学を、一つのエンジンへ。',subtitle='SNS専用デザインシステム',dna='digital_nature',accent='#b8ff2c',background='#07090d',fontFamily='Noto Sans JP',output}){
  ...
  const inputProps={format,seconds,headline,subtitle,dna,accent,background,fontFamily};
...
if(process.argv.includes('--test')){
  console.log(JSON.stringify(validateVideoPlan({format:'reels',seconds:10,headline:'スマホで完結',subtitle:'14DNA-ENGINE'}),null,2));
}
